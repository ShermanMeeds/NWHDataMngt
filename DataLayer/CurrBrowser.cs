...
namespace DataLayer
{
	public class CurrBrowser
	{
		...
		public CurrBrowser(HttpRequest req) {
			...
			System.Web.HttpContext.Current.Session.Add("MTBrowserName", _BrowserName);
			System.Web.HttpContext.Current.Session.Add("MTBrowserType", _BrowserType);
			System.Web.HttpContext.Current.Session.Add("MTBrowserVers", _BrowserVers);
			System.Web.HttpContext.Current.Session.Add("MTBrowserVersMj", _BrowserVersMj);
			System.Web.HttpContext.Current.Session.Add("MTBrowserVersMn", _BrowserVersMn);
			System.Web.HttpContext.Current.Session.Add("MTPlatform", _Platform);
			System.Web.HttpContext.Current.Session.Add("MTJScriptVers", _JScriptVers);
		}
