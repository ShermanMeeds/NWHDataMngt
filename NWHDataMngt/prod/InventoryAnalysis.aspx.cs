...
{
	public partial class InventoryAnalysis : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!_user.IsInRole("invmngtadm") && !_user.IsInRole("datmngtview") && !_user.IsInRole("invmngtedt") && !_user.IsInRole("invmngtvw") && !_user.IsAdmin == true && !_user.IsInRole("datmngtedit"))
			{
