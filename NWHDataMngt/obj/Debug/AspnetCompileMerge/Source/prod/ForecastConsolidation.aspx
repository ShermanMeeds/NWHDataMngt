		...
		function LoadSavedQueryData(val) {
			...
			if (MyQueryData !== undefined && MyQueryData !== null) {
				if (MyQueryData.length > 0) {
					...
					if (cwk === '1') {
						jchkShowCurrentWeek.checked = true;
					}
					else {
						jchkShowCurrentWeek.checked = false;
					}
				...
				<div id="divMainFilters" style="width:100%;text-align:center;">
					...
					<tr>
						<td colspan="13">
							...
							<input type="checkbox" id="chkShowCurrentWeek" onchange="javascript:ChangeCurrentWeekView(this.checked);return false;" checked="checked" />&nbsp;&nbsp;&bull;&nbsp;&nbsp;
