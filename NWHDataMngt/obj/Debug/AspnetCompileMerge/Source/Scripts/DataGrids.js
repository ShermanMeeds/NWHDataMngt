						...
						if (cname.length > 0) {
							if (cname.toUpperCase() === 'ACTION') {
								...
								switch (coltype[col]) {
									...
									case 5: // checkbox
										val = '<input type="checkbox" id="txtInputCol' + sRow + sCol + '"';
										if (dt[row][cname].toString() === '1') { val = val + ' checked="checked"'; }
										val = val + '" onchange="javascript:ChangeCheckBox(' + id + ',' + row.toString() + ',' + col.toString() + ',' + objid.toString() + ',this.value);return false;" />';
										break;
									case 6: // drop down list
										//alert('creating ddl');
