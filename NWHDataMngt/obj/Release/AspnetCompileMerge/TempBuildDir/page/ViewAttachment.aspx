<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAttachment.aspx.cs" Inherits="DataMngt.page.ViewAttachment" %>
...
<head runat="server">
	<title></title>
	<script type="text/javascript" src="../Scripts/jquery-3.2.1.min.js?v=1"></script>
