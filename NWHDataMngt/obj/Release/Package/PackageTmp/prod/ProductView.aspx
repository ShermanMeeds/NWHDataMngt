<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="DataMngt.prod.ProductView" %>
...
<head runat="server">
	...
	<script type="text/javascript">
		...
		var jsColHeader = ['Data Type', 'Region', 'Mill', 'Product', 'Thickness', 'Species', 'Grade', 'Seasoning', 'Surface', 'Length', 'Color', 'Sort', 'Milling', 'NoPrint', ''];
		var jiColWidth = [80, 70, 70, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 0];
		...
		function GetGridColumnSettings() {
			...
			var MyData = "{'PgID':'" + jiPageID.toString() + "','ObjID':'1','UIType':'ProdViewWk','ByID':'" + jiByID.toString() + "'}";
			//alert(MyData);
			getJSONReturnDataAs(url, MyData, function (response)
		...
		function SaveColSettingValue(itm, val) {
			...
			var MyData = "{'PgID':'" + jiPageID.toString() + "','ObjID':'3', 'UserID':'" + jiByID.toString() + "','UIType':'ProdViewWk','Item':'" + itm + "','Val':'" + val + "','Comment':'','Active':'1','ByID':'" + jiByID.toString() + "'}";
			//alert(MyData);
			getJSONReturnDataAs(url, MyData, function (response)
			{ MyColumnSettings = response; });
								...
								if ((jaColVisible[col] === 1 && (col < 14 || col === 39)) || (col > 13 && col < 28 && ShowTac === 1) || (col > 27 && col < 39 && ShowStrat === 1)) {
									...
									switch (col) {
										case 0:
											...
											if (row !== (NbrRows - 1)) { contentNext = MyMainGridData[row + 1]['RecType'].toString(); }
											break;
										case 1:
											content = MyMainGridData[row]['Region'].toString();
											if (row !== (NbrRows - 1)) { contentNext = MyMainGridData[row + 1]['Region'].toString(); }
											break;
										case 2:
											content = MyMainGridData[row]['LocCode'].toString();
											if (row !== (NbrRows - 1)) { contentNext = MyMainGridData[row + 1]['LocCode'].toString(); }
											break;
										case 3:
											content = MyMainGridData[row]['ProdCode'].toString();
											if (row !== (NbrRows - 1)) { contentNext = MyMainGridData[row + 1]['ProdCode'].toString(); }
											break;
										case 4:
											...
											break;
										case 5:
											content = MyMainGridData[row]['Species'].toString();
											if (row !== (NbrRows - 1)) { contentNext = MyMainGridData[row + 1]['Species'].toString(); }
											break;
										case 6:
										...
										default:
											if (col < 39) {
												if (col > 13 && col < 21) {
													fig = MyMainGridData[row]['Wk1_' + (col - 13).toString()].toString();
												}
												if (col > 20 && col < 28) {
													fig = MyMainGridData[row]['Wk2_' + (col - 20).toString()].toString();
												}
												if (col > 27 && col < 39) {
													fig = MyMainGridData[row]['Wk' + (col - 25).toString()].toString();
												}
		...
		function EmptyGridColumnTotals() {
			var okay = true;
			for (var col = 14; col < jiNbrCols; col++) {
				jaColTotals[col-14] = 0;
			}
			return okay;
		}
		...
		function ChangeManagementLvl(val) {
			jiManagementLvl = parseInt(val, 10);
			RefreshGridData();
			jlPageStatus.innerHTML = 'Page Ready';
			return false;
		}
		...
		function BuildTableHeader(typ) {
			...
			for(var col=0; col<16; col++) {
				...
				if(jaColVisible[col]===1) {
					...
					th.id = 'thHdrCol' + sCol;
					th.className = 'TableHdrCell';
					th.style.width = MyColumnSettings[col]['ColumnWidth'].toString() + 'px';
					th.innerHTML = MyColumnSettings[col]['ColumnTitle'].toString();
					line.appendChild(th);
				}
			}
			thd.appendChild(line);
			switch(typ) {
				case 1:	// current
					break;
				case 2: // by day
					for(var dcol=0; dcol<92; dcol++) {
						td = document.createElement("td");

					}
					break;
				case 3: // by week
					for(var dcol=0; dcol<13; dcol++) {
					}
					break;
				case 4: // Point-In-Time
					break;
				default:
					break;
			}
...
<body>
	...
	<form id="Form1" runat="server">
		...
		<asp:HiddenField ID="hfPageID" runat="server" Value="32" />
			...
			<table id="tblColumnSettings" style="font-family: Arial; border-collapse: collapse;">
				...
				<tr>
					...
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting0" checked="checked" onchange="javascript:ChangeColSetting('Col 00', this.checked); return false;" /></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="StdTableCell" style="text-align: center;">9</td>
					<td class="StdTableCell">Length</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting9" checked="checked" onchange="javascript:ChangeColSetting('Col 09', this.checked); return false;" /></td>
				</tr>
				<tr>
					<td class="StdTableCell" style="text-align: center;">1</td>
					<td class="StdTableCell">Region</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting1" checked="checked" onchange="javascript:ChangeColSetting('Col 01', this.checked); return false;" /></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="StdTableCell" style="text-align: center;">10</td>
					<td class="StdTableCell">Color</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting10" checked="checked" onchange="javascript:ChangeColSetting('Col 10', this.checked); return false;" /></td>
				</tr>
				<tr>
					<td class="StdTableCell" style="text-align: center;">2</td>
					<td class="StdTableCell">Location/Mill</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting2" checked="checked" onchange="javascript:ChangeColSetting('Col 02', this.checked); return false;" /></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="StdTableCell" style="text-align: center;">11</td>
					<td class="StdTableCell">Sort</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting11" checked="checked" onchange="javascript:ChangeColSetting('Col 11', this.checked); return false;" /></td>
				</tr>
				<tr>
					<td class="StdTableCell" style="text-align: center;">3</td>
					<td class="StdTableCell">Product</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting3" checked="checked" onchange="javascript:ChangeColSetting('Col 03', this.checked); return false;" /></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="StdTableCell" style="text-align: center;">12</td>
					<td class="StdTableCell">Milling</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting12" checked="checked" onchange="javascript:ChangeColSetting('Col 12', this.checked); return false;" /></td>
				</tr>
				<tr>
					<td class="StdTableCell" style="text-align: center;">4</td>
					<td class="StdTableCell">Thickness</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting4" checked="checked" onchange="javascript:ChangeColSetting('Col 04', this.checked); return false;" /></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="StdTableCell" style="text-align: center;">13</td>
					<td class="StdTableCell">NoPrint</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting13" checked="checked" onchange="javascript:ChangeColSetting('Col 13', this.checked); return false;" /></td>
				</tr>
				<tr>
					<td class="StdTableCell" style="text-align: center;">5</td>
					<td class="StdTableCell">Species</td>
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting5" checked="checked" onchange="javascript:ChangeColSetting('Col 05', this.checked); return false;" /></td>
					<td colspan="4">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting6" checked="checked" onchange="javascript:ChangeColSetting('Col 06', this.checked); return false;" /></td>
					<td colspan="4">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting7" checked="checked" onchange="javascript:ChangeColSetting('Col 07', this.checked); return false;" /></td>
					<td colspan="4">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="StdTableCell" style="text-align: center;">
						<input type="checkbox" id="chkColSetting8" checked="checked" onchange="javascript:ChangeColSetting('Col 08', this.checked); return false;" /></td>
					<td colspan="4">&nbsp;</td>
				</tr>
			</table>
		...
		<div class="container body-content">
			...
			<div id="divPAGEHEADER" style="width: 99%; margin-left: 10px;">
				<div id="divCalendarTitle" style="width: 100%;">
					<label id="lblWebCalHdrTitle" class="LabelGridHdrStd" style="font-size: 11pt;">Product Data View:</label>
				...
				<div id="divMainFilters" style="width: 100%; text-align: center;">
					<table id="divCalFilters" style="padding: 2px; border-spacing: 0px; width: 100%;">
						<tr>
							<th id="thMainFilter00" class="TableHdrCell">Region
							</th>
							<th id="thMainFilter01" class="TableHdrCell">Location
							</th>
							<th id="thMainFilter02" class="TableHdrCell">Species
							</th>
							<th id="thMainFilter03" class="TableHdrCell">Thickness
							</th>
							<th id="thMainFilter04" class="TableHdrCell">Grade
							</th>
							<th id="thMainFilter05" class="TableHdrCell">Seasoning
							</th>
							<th id="thMainFilter06" class="TableHdrCell">Length
							</th>
							<th id="thMainFilter07" class="TableHdrCell">Color
							</th>
							<th id="thMainFilter08" class="TableHdrCell">Sort
							</th>
							<th id="thMainFilter09" class="TableHdrCell">Milling
							</th>
							<th id="thMainFilter10" class="TableHdrCell">NoPrint
							</th>
							<th id="thMainFilter11" class="TableHdrCell">Product
							</th>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="13">View and Scope:&nbsp;
							<select id="selViewTypeF" onchange="javascript:ChangeShowScope(this.value);return false;">
								<option value="1">Current</option>
								<option value="2">By Day</option>
								<option value="3" selected="selected">By Week</option>
								<option value="4">Point-In-Time</option>
							</select>&nbsp;&nbsp;
							<span id="spnTargetDateH" style="display: none;">Target&nbsp;Date:&nbsp;<input type="text" id="txtTargetDateH" style="width: 86px;" />&nbsp;&nbsp;
							</span>
							<select id="selManagementLevel" onchange="javascript:ChangeManagementLvl(this.value);return false;">
								<option value="0" selected="selected">Product</option>
								<option value="1" selected="selected">Product-Attributes</option>
								<option value="2" selected="selected">Attributes</option>
							</select>&nbsp;&nbsp;
							...
							<select id="selQueryList" onchange="javascript:LoadSavedQueryData(this.value);return false;">
								...
								Query Title:&nbsp;<input type="text" id="txtQueryTitle" style="width: 140px;" />&nbsp;
						...
						<tr>
							<td colspan="13">
								<button id="btnRefreshCTData" class="button blue-gradient glossy" onclick="javascript:RefreshConsolidationData();return false;" style="width: 220px;">Display Data</button>
			...
			<div id="divPAGEMAINCONTENT" style="width: 99%; margin-left: 10px;">
				<div id="divFCTitleHdr" style="width: 100%;">
					<table style="width: 100%; border: none; padding: 0px; border-spacing: 0px;">
						<tr>
							<td style="width: 60%;">
								<label id="lblFCGridHdr" style="font-weight: bold; color: blue; font-size: 13pt;">Product Data</label>
							</td>
				...
				<div id="divDataGrid" style="width: 100%;">
					<table id="tblForecastData" style="padding: 1px; border-spacing: 0px; border-collapse: collapse;">
					<thead id="hdFDataGrid">
						<tr>
							<th id="thHdrCol00" class="TableHdrCell" style="width: 80px;">Data Type</th>
							...
							<th id="thHdrCol14" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC; border-left: double;">
								<label id="lblHdrWk1Dy1">Wk1Dy1</label></th>
							<th id="thHdrCol15" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk1Dy2">Wk1Dy2</label></th>
							<th id="thHdrCol16" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk1Dy3">Wk1Dy3</label></th>
							<th id="thHdrCol17" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk1Dy4">Wk1Dy4</label></th>
							<th id="thHdrCol18" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk1Dy5">Wk1Dy5</label></th>
							<th id="thHdrCol19" class="TableHdrCell" style="width: 90px; background-color: aqua;">
								<label id="lblHdrWk1Dy6">Wk1Dy6</label></th>
							<th id="thHdrCol20" class="TableHdrCell" style="width: 90px; background-color: aqua;">
								<label id="lblHdrWk1Dy7">Wk1Dy7</label></th>
							<th id="thHdrCol21" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC; border-left: double;">
								<label id="lblHdrWk2Dy1">Wk2Dy1</label></th>
							<th id="thHdrCol22" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk2Dy2">Wk2Dy2</label></th>
							<th id="thHdrCol23" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk2Dy3">Wk2Dy3</label></th>
							<th id="thHdrCol24" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk2Dy4">Wk2Dy4</label></th>
							<th id="thHdrCol25" class="TableHdrCell" style="width: 90px; background-color: #CCCCCC;">
								<label id="lblHdrWk2Dy5">Wk2Dy5</label></th>
							<th id="thHdrCol26" class="TableHdrCell" style="width: 90px; background-color: aqua;">
								<label id="lblHdrWk2Dy6">Wk2Dy6</label></th>
							<th id="thHdrCol27" class="TableHdrCell" style="width: 90px; background-color: aqua;">
								<label id="lblHdrWk2Dy7">Wk2Dy7</label></th>
							<th id="thHdrCol28" class="TableHdrCell" style="width: 90px; border-left: double;">
								<label id="lblHdrWk3Dy1">Wk3</label></th>
							<th id="thHdrCol29" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk4Dy1">Wk4</label></th>
							<th id="thHdrCol30" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk5Dy1">Wk5</label></th>
							<th id="thHdrCol31" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk6Dy1">Wk6</label></th>
							<th id="thHdrCol32" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk7Dy1">Wk7</label></th>
							<th id="thHdrCol33" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk8Dy1">Wk8</label></th>
							<th id="thHdrCol34" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk9Dy1">Wk9</label></th>
							<th id="thHdrCol35" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk10Dy1">Wk10</label></th>
							<th id="thHdrCol36" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk11Dy1">Wk11</label></th>
							<th id="thHdrCol37" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk12Dy1">Wk12</label></th>
							<th id="thHdrCol38" class="TableHdrCell" style="width: 90px;">
								<label id="lblHdrWk13Dy1">Wk13</label></th>
							<th id="thHdrCol39" class="TableHdrCell" style="width: 100px; border-left: double;">Total</th>
						</tr>
					</thead>
					<tfoot id="tftFDataGrid">
						<tr>
							...
							<td class="StdFtrCellThisPage" id="tfcell14" style="border-left: double;">
								<label id="lblTotal0">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell15">
								<label id="lblTotal1">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell16">
								<label id="lblTotal2">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell17">
								<label id="lblTotal3">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell18">
								<label id="lblTotal4">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell19" style="background-color: aqua;">
								<label id="lblTotal5">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell20" style="background-color: aqua;">
								<label id="lblTotal6">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell21" style="border-left: double;">
								<label id="lblTotal7">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell22">
								<label id="lblTotal8">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell23">
								<label id="lblTotal9">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell24">
								<label id="lblTotal10">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell25">
								<label id="lblTotal11">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell26" style="background-color: aqua;">
								<label id="lblTotal12">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell27" style="background-color: aqua;">
								<label id="lblTotal13">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell28" style="border-left: double;">
								<label id="lblTotal14">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell29">
								<label id="lblTotal15">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell30">
								<label id="lblTotal16">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell31">
								<label id="lblTotal17">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell32">
								<label id="lblTotal18">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell33">
								<label id="lblTotal19">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell34">
								<label id="lblTotal20">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell35">
								<label id="lblTotal21">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell36">
								<label id="lblTotal22">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell37">
								<label id="lblTotal23">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell38">
								<label id="lblTotal24">0</label></td>
							<td class="StdFtrCellThisPage" id="tfcell39" style="border-left: double; color: blue; font-weight: bold; border-color: gray;">
								<label id="lblTotal25">0</label></td>
						</tr>
					</tfoot>
				...
				<div id="divMasterFooter" runat="server" style="border-top: 1px solid gray; line-height: 16px; margin: 0px; font-size: 9pt;">
					<table style="width: 100%; padding: 1px; border-spacing: 0px;">
						<tr>
							...
							<td style="width: 50%; text-align: right;">&nbsp;<span id="spnCurrDateNV" style="color: #A0A0A0;">&nbsp;</span>&nbsp;&nbsp;Session Start:&nbsp;<span id="clockNV" style="color: #A0A0A0;">&nbsp;</span>&nbsp;
							</td>
						</tr>
					</table>
				</div>
