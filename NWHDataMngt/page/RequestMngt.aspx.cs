...
{
	public partial class RequestMngt : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			_PgRights = 1;
			this._CanEdit = false;
			if (_user.IsInRole("reqmngtAdm") || _user.IsAdmin == true)
			{
				this._IsAdmin = 1;
				this._PgRights = 5;
				this._CanEdit = true;
			...
			{
				if (_user.IsInRole("reqmngtedt") || _user.IsInRole("datmngtedit") || _user.IsInRole("reqmngtappr"))
				{
					this._PgRights = 3;
					this._CanEdit = true;
				}
				if (_user.IsInRole("reqmngtappr"))
				{
					this._PgRights = 4;
				}
			}
