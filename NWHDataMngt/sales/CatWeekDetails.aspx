	...
	<script type="text/javascript">
		...
		function PopulateDeepDetails() {
			...
			if(!IsContentsNullUndefEmptyGu(MyProdDeepDetails)) {
				if(MyProdDeepDetails.length>0) {
					if(parseInt(MyProdDeepDetails[0]['NbrRows'], 10)>jiPageSize) {
						document.getElementById('divTablePageBar2').style.display = 'block';
					}
					else {
						document.getElementById('divTablePageBar2').style.display = 'none';
					}
				}
			}
			//alert('done!');
		...
		function DialogAction1(chc, src) {
			return false;
		}
		...
		function ShowDeepDetailDialog() {
			...
			PopulateDeepDetails() ; 
			//content = '<th class="TableHdrCell" style="width:110px;">Customer</th></tr></thead><tbody>';
...
<body>
	...
	<form id="form1" runat="server">
		...
		<div id="divMainPopup" style="display: none;">
			<table id="tblDeepDetails" class="TableMain" style="margin-top: 6px;">
			<thead>
				<tr>
					<th class="TableHdrCell" style="width: 90px;">Type</th>
					<th class="TableHdrCell">Loc</th>
					<th class="TableHdrCell" style="width: 80px;">Length</th>
					<th class="TableHdrCell" style="width: 80px;">Color</th>
					<th class="TableHdrCell" style="width: 80px;">Sort</th>
					<th class="TableHdrCell" style="width: 80px;">Milling</th>
					<th class="TableHdrCell" style="width: 80px;">NoPrint</th>
					<th class="TableHdrCell" style="width: 120px;">Qty</th>
					<th class="TableHdrCell">UoM</th>
					<th class="TableHdrCell" style="width: 100px;">Order</th>
					<th class="TableHdrCell" style="width: 120px;">Load Date</th>
					<th class="TableHdrCell" style="width: 110px;">Customer</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
			...
			<div id="divTablePageBar2" style="width: 99%; text-align: center; display:none; margin-top: 6px; font-family: Calibri; vertical-align: middle;">
				<div id="divTableContainer2" class="effect1" style="border: 1px solid lightgray; width: 320px; line-height: 14px; height: 24px; margin: auto auto;">
					<table style="border: none; padding-left: 20px; padding-right: 20px; border-spacing: 0px; height: 24px; margin: auto auto;">
					<tr>
						<td style="vertical-align: middle;"><a href="#" id="lnkPageFirst2" onclick="javascript:GoToNewPagePj(2, 0, ' + emptyval + ');return false" style="line-height: 12px; height: 18px; width: 30px; font-size: 20pt; text-decoration: none;">&#171;</a>&nbsp;</td>
						<td style="vertical-align: middle;"><a href="#" id="lnkPagePrev2" onclick="javascript:GoToNewPagePj(2, 1, ' + emptyval + ');return false;" style="line-height: 12px; height: 18px; width: 30px; font-size: 20pt; text-decoration: none;">&lsaquo;</a>&nbsp;&nbsp;&nbsp;</td>
						<td style="vertical-align: middle;">Page&nbsp;<label id="lblPageNbr2">1</label>&nbsp;of&nbsp;<label id="lblMaxPgNbr2">' + nbrpgs.toString() + '</label>&nbsp;&nbsp;&nbsp;</td>
						<td style="vertical-align: middle;"><a href="#" id="lnkPageNext2" onclick="javascript:GoToNewPagePj(2, 2, ' + emptyval + ');return false;" style="line-height: 12px; height: 18px; width: 30px; font-size: 20pt; text-decoration: none;">&rsaquo;</a>&nbsp;</td>
						<td style="vertical-align: middle;"><a href="#" id="lnkPageLast2" onclick="javascript:GoToNewPagePj(2,3, ' + emptyval + ');return false;" style="line-height: 12px; height: 18px; width: 30px; font-size: 20pt; text-decoration: none;">&#187;</a>&nbsp;&nbsp;&nbsp;</td>
						<td style="vertical-align: middle;">Goto&nbsp;Page:&nbsp;<input type="text" id="txtGotoPgNbr2" onblur="javascript:GoToNewPagePj(2, 4, this.value);" style="width: 20px; height: 18px; line-height: 16px; padding: 0px; margin: 0px;" /></td>
					</tr>
					</table>
				</div>
			</div>

			<div id="divPriorOrders" style="width:100%;display:none;">
				<label id="lblPriorOrdersHdr" style="color:darkgreen; font-size: 11pt; font-weight: bold;">Orders Against Beginning Inventory:</label>
				<table id="tblPriorOrdersDetail" style="border-spacing:0px;padding:1px;">
				<thead>
					<tr>
						<th class="TableHdrCell" style="width: 90px;">Ord Nbr</th>
						<th class="TableHdrCell" style="width:60px;">P/T</th>
						<th class="TableHdrCell" style="width: 80px;">ProdCode</th>
						<th class="TableHdrCell" style="width: 90px;">Color</th>
						<th class="TableHdrCell" style="width: 90px;">Sort</th>
						<th class="TableHdrCell" style="width: 90px;">NoPrint</th>
						<th class="TableHdrCell" style="width: 80px;">Loc</th>
						<th class="TableHdrCell" style="width: 90px;">Cust</th>
						<th class="TableHdrCell" style="width: 90px;">Tgt Date</th>
						<th class="TableHdrCell" style="width: 90px;">Qty</th>
					</tr>
				</thead>
				</table>
			</div>
			<div id="divCurrentOrderProjection" style="width: 100%; display: none;">
				<label id="lblCurrentOrdersHdr" style="color: darkgreen; font-size: 11pt; font-weight: bold;">Orders Against Thirteen Weeks:</label>
				<table id="tblCurrentOrdersDetail" style="border-spacing: 0px; padding: 1px;">
				<thead>
					<tr>
						<th class="TableHdrCell" style="width: 90px;">Ord Nbr</th>
						<th class="TableHdrCell" style="width: 60px;">P/T</th>
